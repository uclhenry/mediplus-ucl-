...
function loadTwitterGraphValues(){
  ...
  /*var $http = angular.injector(['ng']).get('$http');
	  ...
	  function addgraph()
  {
  document.getElementById("line-chart2").innerHTML = '<div class="chart-container"><canvas id="line_find" class="chart chart-line chart-xl ng-isolate-scope" data="line2.data" labels="line2.labels" legend="true" series="line2.series" click="line2.onClick" width="193" height="96" style="width: 193px; height: 96px;"></canvas><chart-legend><ul class="line-legend"><li><span style="background-color:rgba(151,187,205,1)"></span>Series A</li><li><span style="background-color:rgba(220,220,220,1)"></span>Series B</li></ul></chart-legend></div>';
...
//prompt(document.getElementById("line-chart2").innerHTML,document.getElementById("line-chart2").innerHTML);
// 
//var c = document.getElementsByTagName("container")[0];
   // var x = c.childNodes[0].nodeValue; 
//document.write("<h1>Hello World!</h1>");
var newDirective = angular.element('<canvas id="line-customline-v2" class="chart chart-line chart-xl" data="survellianceline.data" labels="survellianceline.labels" legend="true" click="survellianceline.onClick" series="survellianceline.series" options="survellianceline.options" colours="survellianceline.colours"></canvas>');
$compile(newDirective)($scope);document.getElementById("line-chart2").append(newDirective);
//prompt(document.getElementById("changedata").data,document.getElementById("line customline-v1").data);
//document.getElementById("changedata").data= "line2.data";
