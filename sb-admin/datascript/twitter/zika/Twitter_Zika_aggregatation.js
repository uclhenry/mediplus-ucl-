...
var aggregateRestaurants = function(db, callback) {
  var source = "Twitter_Zika_simplify";
  var target = "Twitter_Zika_aggregatation";
var targetcollection = db.collection('Twitter_Zika_aggregatation');//
   ...
   x.forEach(function(doc) {
         ...
         insertonerecord("Zika",doc._id.year,doc._id.month,doc._id.day,doc.counter,targetcollection);
